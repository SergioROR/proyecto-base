...
class Operaciones:
    ...
    def multiplicar(self):
        self.resultado = "La multiplicacion de " + str(self.num1) + " x " + str(self.num2) + " es igual a " + str(self.num1 * self.num2)

    #operación de restar
    def dividir(self):
        self.resultado = "La divicion de " + str(self.num1) + " / " + str(self.num2) + " es igual a " + str(self.num1 / self.num2)
